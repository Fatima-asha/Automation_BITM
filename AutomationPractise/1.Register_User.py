...
def register_user():
    driver = webdriver.Firefox(executable_path="G:\\SQA Class\\geckodriver-v0.32.2-win64.exe")
    ...
    try:
        ...
        driver.get_screenshot_as_file("G:\\SQA Class\\Automation all\\Automation\\Screenshot\\Defect.png")
    ...
    # Skip Ad
    #skip_ad = driver.find_element(By.CSS_SELECTOR, "#dismiss-button")
    #skip_ad.click()
